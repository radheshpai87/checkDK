...
def predict_cmd(
    ...
    Sends metrics to the checkDK API which runs the Random Forest model
    and (optionally) asks the LLM for an actionable health assessment.
    ...
    \b
    Example – high-risk pod with LLM:
